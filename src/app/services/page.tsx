    ...
    <div className="flex-1 bg-[#020202] text-[#e3e2e2] selection:bg-white selection:text-black font-sans min-h-screen flex flex-col">
      ...
      <main className="flex-1 pt-32 px-6 pb-24">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-lg text-[#8e9192] max-w-3xl mb-16 leading-relaxed">
          ...
          <div className="mb-20">
            <div className="flex items-center gap-4 mb-8 pb-4 border-b border-white/10">
              ...
              <h2 className="text-2xl font-bold text-white tracking-tight">Commerce Engineering</h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="p-8 border border-white/10 bg-[#050505] rounded-sm flex flex-col justify-between">
                <div>
                  ...
                  <h3 className="text-xl font-bold text-white mb-4">Shopify Custom Engineering</h3>
                ...
                <div>
                  ...
                  <Link href="/contact" className="font-mono text-[10px] uppercase tracking-widest text-white hover:text-emerald-400 transition-colors">
              ...
              <div className="p-8 border border-white/10 bg-[#050505] rounded-sm flex flex-col justify-between">
                <div>
                  ...
                  <h3 className="text-xl font-bold text-white mb-4">Shopify Store Design & CRO</h3>
                  <p className="text-sm text-[#8e9192] mb-6 leading-relaxed">
              ...
              <div className="p-8 border border-white/10 bg-[#050505] rounded-sm flex flex-col justify-between">
                <div>
                  ...
                  <h3 className="text-xl font-bold text-white mb-4">Shopify Bug Fixes & Troubleshooting</h3>
                  <p className="text-sm text-[#8e9192] mb-6 leading-relaxed">
              ...
              <div className="p-8 border border-white/10 bg-[#050505] rounded-sm flex flex-col justify-between">
                <div>
                  ...
                  <h3 className="text-xl font-bold text-white mb-4">Headless Shopify Engineering</h3>
                  <p className="text-sm text-[#8e9192] mb-6 leading-relaxed">
              ...
              <div className="p-8 border border-white/10 bg-[#050505] rounded-sm flex flex-col justify-between">
                <div>
                  ...
                  <h3 className="text-xl font-bold text-white mb-4">Accessibility & Inclusive Commerce</h3>
                  <p className="text-sm text-[#8e9192] mb-6 leading-relaxed">
          ...
          <div className="mb-20">
            <div className="flex items-center gap-4 mb-8 pb-4 border-b border-white/10">
              ...
              <h2 className="text-2xl font-bold text-white tracking-tight">Product Engineering</h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="p-8 border border-white/10 bg-[#050505] rounded-sm flex flex-col justify-between">
                <div>
                  ...
                  <h3 className="text-xl font-bold text-white mb-4">Full-Stack Web Applications</h3>
                  <p className="text-sm text-[#8e9192] mb-6 leading-relaxed">
              ...
              <div className="p-8 border border-white/10 bg-[#050505] rounded-sm flex flex-col justify-between">
                <div>
                  ...
                  <h3 className="text-xl font-bold text-white mb-4">AI-Powered B2B SaaS</h3>
                  <p className="text-sm text-[#8e9192] mb-6 leading-relaxed">
          ...
          <div>
            <div className="flex items-center gap-4 mb-8 pb-4 border-b border-white/10">
              ...
              <h2 className="text-2xl font-bold text-white tracking-tight">Intelligent Automation</h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="p-8 border border-white/10 bg-[#050505] rounded-sm flex flex-col justify-between">
                <div>
                  ...
                  <h3 className="text-xl font-bold text-white mb-4">Custom AI Agents & Intelligent Systems</h3>
                  <p className="text-sm text-[#8e9192] mb-6 leading-relaxed">
              ...
              <div className="p-8 border border-white/10 bg-[#050505] rounded-sm flex flex-col justify-between">
                <div>
                  ...
                  <h3 className="text-xl font-bold text-white mb-4">AI Voice Agents</h3>
                  <p className="text-sm text-[#8e9192] mb-6 leading-relaxed">
