  ...
  return (
    <div className="flex-1 bg-[#020202] text-[#e3e2e2] selection:bg-white selection:text-black font-sans">
      ...
      <main className="pt-16">
        {/* SECTION 01 — HERO SYSTEM */}
        <section className="relative min-h-[90vh] flex flex-col justify-center overflow-hidden border-b border-white/5 bg-black">
          ...
          <div className="absolute inset-0 z-0">
            ...
            <div className="hidden md:block absolute inset-0">
              ...
              <img
                ...
                className="w-full h-full object-cover object-right-top opacity-70"
              />
              {/* Cinematic Vignette Overlay to ensure text readability on the left */}
              <div className="absolute inset-0 bg-gradient-to-r from-[#020202] via-[#020202]/90 via-40% to-transparent" />
            ...
            <div className="block md:hidden absolute inset-0">
              ...
              <img
                src={mobileHeroAsset}
                alt="Mudasar Imam - Mobile Portrait"
                className="w-full h-full object-cover object-center opacity-40"
              />
              {/* Mobile Gradient Overlay */}
              <div className="absolute inset-0 bg-gradient-to-b from-[#020202]/90 via-[#020202]/70 to-[#020202]" />
            </div>
          </div>

          {/* Hero Content */}
          <div className="relative z-10 max-w-7xl mx-auto px-6 py-20 w-full min-h-[80vh] flex flex-col justify-center">
            <div className="max-w-2xl">
              <div className="inline-flex items-center gap-2 font-mono text-[10px] text-[#8e9192] uppercase tracking-[0.3em] mb-6 px-3 py-1 bg-white/5 border border-white/10 rounded-[2px]">
                <span className="w-1.5 h-1.5 rounded-full bg-emerald-400 animate-pulse"></span>
                IMAM ESTUDIO · TECHNICAL STUDIO
              </div>

              <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold mb-8 leading-[1.05] tracking-tighter text-white">
                Elite AI Automation & <br /> Technical Engineering Studio.
              </h1>

              <p className="text-base sm:text-lg text-[#b0b3b5] mb-10 leading-relaxed font-normal max-w-xl">
              ...
              <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4">
                <Link
                  href="/contact"
                  className="px-8 py-4 bg-white text-black font-sans text-sm font-bold tracking-wide hover:bg-opacity-90 transition-all text-center rounded-[2px] shadow-lg shadow-white/5"
                >
                  Start a Project
                </Link>
                <Link
                  href="/services"
                  className="px-8 py-4 bg-transparent border border-white/20 text-white font-sans text-sm font-bold tracking-wide hover:border-white/50 transition-all text-center rounded-[2px]"
                >
              ...
              <div className="mt-8">
                <a
                  ...
                  className="inline-flex items-center gap-2 font-mono text-[11px] text-[#8e9192] hover:text-white transition-colors underline underline-offset-4 decoration-white/20 hover:decoration-white/50"
                >
          ...
          <div className="max-w-7xl mx-auto">
            <div className="mb-16 flex flex-col md:flex-row md:items-end justify-between gap-6">
              <div>
                ...
                <h2 className="text-3xl font-extrabold tracking-tighter text-white mb-2">Featured Engineering Work</h2>
              ...
              <Link href="/work" className="font-mono text-[11px] text-white hover:text-[#8e9192] transition-colors whitespace-nowrap">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="group cursor-pointer">
                <div className="relative aspect-[4/3] bg-[#0a0a0a] border border-white/10 rounded-sm overflow-hidden mb-6">
                  {/* eslint-disable-next-line @next/next/no-img-element */}
                  <img
                    src="https://fiverr-res.cloudinary.com/t_main1,q_auto,f_auto/gigs/493991616/original/86712b96d3f090661b268a8e39f3c7db81967c35.png"
                    alt="Headless Shopify Architecture"
              ...
              <div className="group cursor-pointer">
                <div className="relative aspect-[4/3] bg-[#0a0a0a] border border-white/10 rounded-sm overflow-hidden mb-6">
                  {/* eslint-disable-next-line @next/next/no-img-element */}
                  <img
                    src="https://fiverr-res.cloudinary.com/t_main1,q_auto,f_auto/gigs/495364262/original/522d3fc9e1da6d765067f8bf78fdf8e1b33a8690.png"
